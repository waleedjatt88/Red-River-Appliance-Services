...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#11141a] text-gray-300 pt-16 pb-10 select-none border-t border-slate-800/60">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12 border-b border-slate-800/70">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                href="#"
                aria-label="Facebook"
                className="w-9 h-9 rounded-full bg-slate-800/90 border border-slate-700/70 text-gray-300 flex items-center justify-center hover:bg-[#D31820] hover:text-white hover:border-[#D31820] transition-all duration-200"
              >
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-3.5 text-xs sm:text-[13px] text-gray-400">
              
              {/* Phone */}
              <li className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center text-[#D31820] shrink-0">
              ...
              <li className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center text-[#D31820] shrink-0">
                  <Mail className="w-3.5 h-3.5 text-[#D31820]" />
                </div>
              ...
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center text-[#D31820] shrink-0 mt-0.5">
              ...
              <li className="flex items-start gap-3 pt-1">
                <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center text-[#D31820] shrink-0 mt-0.5">
                  <Clock className="w-3.5 h-3.5 text-[#D31820]" />
                </div>
                <span>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-gray-400">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-red-500/10 flex items-center justify-center text-[#D31820] shrink-0">
              <ShieldCheck className="w-4 h-4 text-[#D31820]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-red-500/10 flex items-center justify-center text-[#D31820] shrink-0">
              <Phone className="w-4 h-4 text-[#D31820]" />
            </div>
            <div>
              <span className="block font-bold text-gray-200">
